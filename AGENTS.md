...
- Capital-normalized executable return (bid credit / secured capital / DTE) is the primary ranking axis for compounding toward 5x. Per-contract premium velocity remains visible and breaks ties; secondary scoring qualifies but never outranks capital return.
