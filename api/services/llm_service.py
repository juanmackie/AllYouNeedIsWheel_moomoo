...
def build_advisor_context():
    ...
    try:
        ...
        positions_map = {_bare_ticker(p.get("symbol", "")): p for p in (portfolio_svc.get_positions("STK") or [])}
        ...
        for pos in opt_positions:
            ...
            try:
                ...
                iv_adj, iv_rank, iv_status = iv_svc.get_iv_environment_score(ticker, iv if iv > 0 else 0.20)
