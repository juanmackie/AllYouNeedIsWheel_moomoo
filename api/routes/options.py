...
def _catalyst_empty_response(
    generated_at=None, thresholds=None, message=None, cache_age_seconds=None, served_from_cache=False
):
    ...
    fallback_thresholds = {}
    for k in (
        "min_premium_notional",
        "min_fresh_volume_ratio",
        "min_volume",
        "max_expirations",
        "max_dte",
        "max_scan_tickers",
...
def _add_freshness_metadata(
    payload, served_from_cache, cache_age_seconds, fresh_attempted, fresh_succeeded, last_successful_generated_at
):
