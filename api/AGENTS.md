...
- Security: enforce controls by implementation, not guidance alone (§7); readonly contract is structural; never invent packages/APIs (§3.3); apply closeout format (§13) at finish.
